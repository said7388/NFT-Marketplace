  ...
  return (
    <section className="bg-[#D9E0EC33]">
      <div className="section-container py-16">
        <h2 className="text-[34px] font-bold font-integralcf">Discover more NFTs</h2>
          ...
          <div className="flex gap-3 items-center flex-wrap">
            {
              categories.map((category, index) => (
                ...
                >
                  <span className={`-z-1 absolute left-0 top-0 rounded bg-[#3D00B7] transition-all duration-500 ease-out group-hover:h-full group-hover:w-full  ${category.value === selectedCategory ? "h-full w-full" : "h-0 w-0"}`} />
